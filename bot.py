...
async def kick(context, member: discord.Member):
    ...
    kickembed.add_field(name='User: {member.mention}', value=f'(ID: {member.id}) ', inline=False)
...
async def ban(context, member: discord.Member):
    ...
    banembed.add_field(name='User: {member.mention}', value=f'(ID: {member.id}) ', inline=False)
    channel = client.get_channel(780760958242652160)
